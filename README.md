...
## Tech Stack and Tools used:
      ...
      2) Database: SQLite
      3) APIs used: MailTrap, Razorpay Payment Gateway, Django PDF library, Django channels for chat, ngrok HTTP, PyPI packages.

## Contributors

- **Team Members:** Lingaraj, Manigandhan, Lahari, Sindhu
- **Project Duration:** Dec 2025 - Jun 2026
...
#### [Razorpay API](https://razorpay.com/) - a payment gateway that supports multiple payment methods including cards, UPI, wallets, and net banking.
...
## Installation Details
      ...
      The credentials that you need to set up are: Mailtrap credentials, Razorpay Key ID, Razorpay Key Secret. 
